...
<div id="wrap">
    ...
    <div id="content">
        ...
        <!-- 表示するデータをdbから取ってくる -->
        <?php $stmt = $db->prepare(
            'select p.id, p.member_id, p.message, p.created, 
            ...
            // fecthでとってきたデータを配列で処理(表示)
            while($stmt->fetch()): 
        ?>
        <div class="msg">
            <!-- 画像は、それ自体をデータベースで管理するのではなく、ファイル名のみ管理 -->
            <!-- 画像そのものを入れると重くなりすぎるので -->
            <?php if($picture): ?>
